	...
	return (
		<div>
			<div className={styles.images_container}>
				<div className={`${styles.basic_img} ${selectedIndex === 0 ? styles.selected : ''}`} onClick={() => handleSelectImage(0)}>
					<Image src={basicImgOne} alt={'기본사진 1'} />
				</div>
				<div className={`${styles.basic_img} ${selectedIndex === 1 ? styles.selected : ''}`} onClick={() => handleSelectImage(1)}>
					<Image src={basicImgTwo} alt={'기본사진 2'} />
				</div>
				<div className={`${styles.basic_img} ${selectedIndex === 2 ? styles.selected : ''}`} onClick={() => handleSelectImage(2)}>
					<Image src={basicImgThree} alt={'기본사진 3'} />
				</div>
				<div className={`${styles.basic_img} ${selectedIndex === 3 ? styles.selected : ''}`} onClick={() => handleSelectImage(3)}>
